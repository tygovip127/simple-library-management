...
//			Reader reader = loanModify.testReaderId(Integer.parseInt(tfReaderId.getText()));
	...
	{
		lblStatisticTotalBook.setText("Tổng số sách: "+client.requestStatistic("getStatisticTotalBook"));
		lblStatisticTotalLoan.setText("Tổng số phiếu mượn sách: "+client.requestStatistic("getStatisticTotalLoan"));
		lblStatisticLoan.setText("Sách đang cho mượn: "+client.requestStatistic("getStatisticLoan"));
		lblStatisticPunish.setText("Sách bị trễ hạn trả: "+client.requestStatistic("getStatisticPunish"));
	}
